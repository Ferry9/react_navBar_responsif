        ...
        <div className="lg:flex md:flex lg:flex-1 items-center justify-end font-normal hidden">
          <div className="flex-10">
            <ul className="flex gap-8 mr-16 text-[18px] ">
              ...
              <RouterLink to="https://react-navbar-responsif.onrender.com//Home" className="hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer text-white no-underline">
                <li>Home</li>
              </RouterLink>

              <RouterLink to="https://react-navbar-responsif.onrender.com/Contact" className="hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer text-white no-underline">
                <li>Contact</li>
              </RouterLink>

              <RouterLink to="https://react-navbar-responsif.onrender.com//About" className="hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer text-white no-underline">
                <li>About</li>
              </RouterLink>
            </ul>
          </div>
